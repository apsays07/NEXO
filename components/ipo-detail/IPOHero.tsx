...
export function IPOHero({ ipo }: IPOHeroProps) {
  return (
    <Card id="overview" className="p-6 md:p-8 bg-white border-[#E2E8F0] shadow-2xs font-sans">
      <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-6">
        {/* Left Side Info */}
        <div className="space-y-4 lg:w-2/3">
          <div className="flex items-center gap-3">
            <div className="w-12 h-12 rounded-2xl bg-[#EFF6FF] text-[#2563EB] flex items-center justify-center font-bold text-base border border-[#BFDBFE]">
              {ipo.logo}
            </div>
            <div>
              <div className="flex items-center gap-2 mb-0.5">
                <span className="text-xs text-[#5F6673] font-semibold">
                  {ipo.company}
                </span>
        ...
        <div className="p-5 rounded-2xl bg-[#F8FAFC] border border-[#E2E8F0] lg:w-1/3 flex flex-col justify-between space-y-4">
          <div>
            <span className="text-xs font-medium text-[#5F6673] uppercase tracking-wider block mb-1">
              Offer Price Band
            </span>
          ...
          <div className="grid grid-cols-3 gap-2 pt-3 border-t border-[#E2E8F0] text-xs">
            <div>
              <span className="text-[#5F6673] block text-[12px] font-medium">Lot Size</span>
              <span className="font-semibold text-[#111318] num-tabular">
                {ipo.metrics.lotSize} shares
              </span>
            </div>
            <div>
              <span className="text-[#5F6673] block text-[12px] font-medium">Min Investment</span>
              <span className="font-semibold text-[#111318] num-tabular">
            ...
            <div>
              ...
              <span className="font-semibold text-[#D97706] flex items-center gap-0.5">
                <Clock size={12} />
