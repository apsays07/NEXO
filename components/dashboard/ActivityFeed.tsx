    ...
    <Card className="p-6 bg-surface border-line shadow-2xs flex flex-col justify-between h-full font-sans">
      <div>
        <div className="flex items-center justify-between mb-4">
          ...
          <span className="text-xs text-ink-secondary font-medium">Activity Log</span>
        </div>
        ...
        <div className="space-y-3.5">
          {activities.slice(0, 5).map((act) => (
            <div
              key={act.id}
              className="flex items-start gap-3 p-1.5 rounded-xl hover:bg-page transition-colors"
            >
              <img
              ...
              <div className="flex-1 overflow-hidden">
                ...
                <div className="text-[11px] text-ink-secondary line-clamp-1 mt-0.5 font-normal">
                  {act.subtitle}
                </div>
                <div className="text-[10px] text-ink-tertiary font-mono mt-1">
                  {act.timestamp}
                </div>
              </div>
            </div>
      ...
      <div className="mt-4 pt-3 border-t border-line text-center">
        <span className="text-[11px] text-ink-secondary font-normal">
