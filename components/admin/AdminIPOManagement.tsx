    ...
    return (
      <div className="p-8 max-w-lg mx-auto text-center space-y-4 font-sans mt-12 bg-white border border-rose-200 rounded-3xl shadow-xl">
        ...
        <p className="text-xs text-slate-500 font-medium">
          You need Admin privileges to access the Admin IPO Management page.
        </p>
        <a
          href="/"
          className="inline-flex items-center gap-2 px-5 py-2.5 rounded-2xl bg-blue-600 text-white font-bold text-xs hover:bg-blue-700 transition-all shadow-md"
        >
